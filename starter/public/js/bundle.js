        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Você está logado!!!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Erro ao fazer logout! Tente novamente.');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'senha' ? 'http://localhost:3000/api/v1/vereadores/updateMyPassword' : 'http://localhost:3000/api/v1/vereadores/updateMe';
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " ").concat(type === 'dados' ? " atualizados com sucesso!" : ' atualizada com sucesso!'));
            }
...
var saveSetting = document.querySelector('.form-user-data');
var passwordSetting = document.querySelector('.form-user-password');
...
if (saveSetting) saveSetting.addEventListener('submit', function (e) {
  ...
  console.log(form);
  (0, _updateSettings.updateData)(form, 'dados');
});
if (passwordSetting) passwordSetting.addEventListener('submit', /*#__PURE__*/function () {
